...
namespace math {  // nova was here and i did all of this stop larping me u weridos fuck u all for skidding my source i want all u to die and i made this 80% and btw axion is a skid, law is ok and im a better coder then geno haha lmao  and btw u all are skids lmao lol if ur still reading this i hate u all lol stop reading omg lol ahahahahahahahhaahahahahah ur stupid shut up ik law is reading this btw 
    ...
    //   inline static Vector3 lookvec(const Matrix3& rotationMatrix) { return rotationMatrix.getColumn(2); }
      // inline static Vector3 rightvec(const Matrix3& rotationMatrix) { return rotationMatrix.getColumn(0); }
